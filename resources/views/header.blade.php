			...
			<div class="container">
				<div class="pull-left">
					...
					<div class="header-logo">
						<a class="logo" href="{{ route('trang-chu') }}">
				...
				<div class="pull-right">
					<ul class="header-btns">
						...
						<li class="header-account dropdown default-dropdown" style="width: 200px;">
							...
							<ul class="custom-menu">
								<li><a href="{{ route('trangchu') }}"><i class="fa fa-user-o"></i>Admin</a></li>
			...
			<div id="responsive-nav">
				...
				<div class="menu-nav">
					...
					<ul class="menu-list">
						...
						<li><a href="{{route('sp_new')}}">HÀNG MỚI VỀ</a></li>
						<li><a href="{{route('sp_sale')}}">HÀNG GIẢM GIÁ</a></li>
